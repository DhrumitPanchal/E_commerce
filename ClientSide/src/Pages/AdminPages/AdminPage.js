...
function AdminPage({ Path }) {
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)]">
      <aside className=" flex flex-col min-h-[calc(100vh-3.5rem)] w-[15rem] bg-black/5">
        <Link
          to={"/"}
          className="cursor-pointer flex items-center gap-[1rem] px-[1rem] py-[.6rem] h-fit w-full border-b-[1px] border-black/50 text-[1.2rem] transition-colors duration-300 text-black font-bold "
        >
